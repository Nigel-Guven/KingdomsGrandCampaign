...
def main():
    ...
    with open("../input/descr_strat_campaign_settings.txt", "r") as f:
        campaign_settings = f.read()
    with open("../input/descr_strat_resources.txt", "r") as f:
        resources = f.read()
    with open("../input/descr_strat_script_plugins.txt", "r") as f:
        script_plugin = f.read()
    
    with open("../output/descr_strat_modified.txt", "w", encoding="utf-8") as dst:
